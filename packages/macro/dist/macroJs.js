...
var MacroJs = /*#__PURE__*/function () {
  ...
  function MacroJs(_ref, _ref2) {
    ...
    (0, _defineProperty2.default)(this, "replaceDefineMessage", function (path) {
      // reset the expression counter
      _this._expressionIndex = (0, _utils.makeCounter)();
      var argValue = path.node.arguments[0];
      var newNode = _this.types.isTemplateLiteral(argValue) || _this.types.isStringLiteral(argValue) ? _this.types.objectExpression([_this.types.objectProperty(_this.types.identifier(_constants.MESSAGE), argValue)]) : argValue;

      var descriptor = _this.processDescriptor(newNode);
